...
class TrailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trailer" do
    assert_difference('Trailer.count') do
      post trailers_url, params: { trailer: { CHASSIS: @trailer.CHASSIS, FABDATE: @trailer.FABDATE, INFO: @trailer.INFO, NB_PLATE: @trailer.NB_PLATE } }
    end
  ...
  test "should update trailer" do
    patch trailer_url(@trailer), params: { trailer: { CHASSIS: @trailer.CHASSIS, FABDATE: @trailer.FABDATE, INFO: @trailer.INFO, NB_PLATE: @trailer.NB_PLATE } }
