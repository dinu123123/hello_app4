...
class PricingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post pricings_url, params: { pricing: { CLIENT_id: @pricing.CLIENT_id, DATETIME: @pricing.DATETIME, DESCRIPTION: @pricing.DESCRIPTION, price_per_day: @pricing.price_per_day, price_per_km: @pricing.price_per_km, surcharge: @pricing.surcharge } }
    end
  ...
  test "should update pricing" do
    patch pricing_url(@pricing), params: { pricing: { CLIENT_id: @pricing.CLIENT_id, DATETIME: @pricing.DATETIME, DESCRIPTION: @pricing.DESCRIPTION, price_per_day: @pricing.price_per_day, price_per_km: @pricing.price_per_km, surcharge: @pricing.surcharge } }
