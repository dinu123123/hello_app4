class RepairsController < ApplicationController
  ...
  def index
    ...
    @repairs = @search.scope_repairs_index
  end
  ...
  def create
    @repair = Repair.new(repair_params)
     ...
     @repair.images.attach(params[:periodic][:images])
    end
  ...
  def delete_image
    ...
    @image.purge
    redirect_back(fallback_location: repairs_path)
  end
  ...
  private
    ...
    def repair_params
      params.require(:repair).permit(:date_repair, :km, :DRIVER_id, :truck_id, :trailer_id, 
        :driver_expense_id, :truck_expense_id, :description, :mechanic_name, images: [])
    end
end
